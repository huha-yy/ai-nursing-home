...
Skills define *how* tools work. This file describes the tools available to 5号楼楼长.
...
2. **失语老人沟通**: `resident-query` 查R025偏好和常用表达 → 确保护工备好写字板 → 关注血氧波动
3. **进食困难干预**: `alert-query` 查R029进食预警 → `meal-query` 确认今日菜单 → 安排护工耐心引导进食
